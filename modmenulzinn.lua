...
getgenv().Settings = {
    ...
    AimNPC = false -- Nova Opção
}

local VERSION = "v5.0.8"
local CHANGELOG_TEXT = [[
--- CORREÇÕES v5.0.8 ---
[!] CRÍTICO: Anti-Ghost ESP (Lógica de limpeza triplicada).
[+] MIRA: Adicionado Auxílio de Mira em NPCs.
[+] FIX: Chams agora são destruídos corretamente ao deslogar.
[+] UI: Ajuste fino no reset de posição central.
-------------------------]]
