...
--- CORREÇÕES v5.0.1 ---
[!] CRÍTICO: Todas as abas restauradas novamente.
[+] MIRA: Adicionado WALL CHECK (não mira através de paredes).
[+] FOV: Círculo agora centralizado e com ajuste de tamanho.
[+] TP: Sistema de Seções e Scroll Vertical mantidos.
-------------------------]]
...
RunService.RenderStepped:Connect(function()
    ...
    FOVCircle.Visible = Settings.ShowFOV; FOVCircle.Radius = Settings.AimFOV; FOVCircle.Position = Vector2.new(Camera.ViewportSize.X/2, Camera.ViewportSize.Y/2); FOVCircle.Color = Color3.new(1,1,1); FOVCircle.Thickness = 1
